                        ...
                        <div class="formCard ">
                            ...
                            <div class="row">
                                <div class="col-12 pb-3 p-2">
                                    ...
                                    <input data-validation="required,length" @if($user!='') value="{{$user->name}}"  @endif data-validation-length="min2" type="text" class="form-control"  name="name" id="name" placeholder="{{__('frontend.enter FullName')}}">
                                </div>
                                <div class="col-12 pb-3 p-2">
                                    <label for="Phone" class="form-label"> <i class="fas fa-phone-alt me-2"></i>  {{__('frontend.phone')}}* </label>
                                    <input onkeypress="return isNumber(event)" @if($user!='') value="{{$user->phone}}"  @endif data-validation="required,validatePhoneNumberOfSAR" class="form-control"  id="Phone" name="phone" placeholder="5********">
                                </div>
                                <div class="col-12 pb-3 p-2">
                    ...
                    <div class="col-md-8 pb-3 p-2">
                        ...
                        <div class="formCard">
                            ...
                            <div class="col-12 pt-4 p-2 text-center">
                                ...
                                <button id="submit_button" type="submit" class="defaultBtn mx-1">
                                    {{__('frontend.Send')}}
                                    <span></span>
                                </button>
                            </div>
