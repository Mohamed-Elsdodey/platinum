            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 p-1">
                    ...
                    <div class="profileNavCol">
                        <a href="{{route('profile.CurrentOrders')}}" id="activeButton" class=" change_part_of_profile loadTimer" > <i class="fa-solid fa-user-hair-mullet me-2"></i> {{trans('frontend.Recruitment requests')}}</a>
                        <a href="{{route('profile.OrdersHistory')}}"  class="change_part_of_profile" > <i class="fa-solid fa-user-headset me-2"></i> {{trans('frontend.order book')}} </a>
                        <a href="{{route('profile.Notifications')}}"  class="change_part_of_profile" > <i class="fas fa-bell me-2"></i> {{trans('frontend.notifications')}} </a>
                        <a href="{{route('profile.editProfile')}}"  class="change_part_of_profile" ><i class="fas fa-cog me-2"></i> {{trans('frontend.account settings')}} </a>
