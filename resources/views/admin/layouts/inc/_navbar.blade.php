    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{route('laborDemands.index')}}" class="waves-effect">
                        <i class="fa fa-tasks" aria-hidden="true"></i>
                        <span class="badge rounded-pill bg-info float-end"></span>
                        <span key="t-dashboards">طلبات العمل اليومية </span>
                    </a>
                </li>
                @endif
                ...
                @if(checkPermission(29))
                    <li>
                        <a href="{{route('admin.getRecruitmentTrip')}}" class="waves-effect">
                            <i class="bx bxs-user-detail"></i>
                            <span class="badge rounded-pill bg-info float-end"></span>
                            <span key="t-dashboards">رحلة الاستقدام</span>
                        </a>
                    </li>
                @endif
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li>
                                <a href="{{route('sponsors.index')}}">
                                    ...
                                    <span class="badge rounded-pill bg-info float-end"></span>
                                    <span key="t-dashboards"> الرعاة </span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{route('admin.getRecruitmentRequirement')}}">
                                    <i class="bx bx-pie-chart-alt-2"></i>
                                    <span class="badge rounded-pill bg-info float-end"></span>
                                    <span key="t-dashboards"> {{trans('frontend.Recruitment requirements')}} </span>
                                </a>
                            </li>
