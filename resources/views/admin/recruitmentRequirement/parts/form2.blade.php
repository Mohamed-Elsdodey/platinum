                    ...
                    <div class="form-group">
                        ...
                        <textarea data-validation="" rows="6" class="form-control "
                                  ...
                                  placeholder="النص عن خدماتنا ">
                                                         {{$row2->getTranslation('title', $language->title)}}
                                                     </textarea>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-2">
                    <div class="form-group">
                        ...
                        <textarea data-validation="" rows="6" class="form-control "
                                  ...
                                  id="summernote1{{$language->title}}"
                                  placeholder="النص عن خدماتنا ">
                                                         {{$row2->getTranslation('copy_of_the_national_IDor_residence_for_residents', $language->title)}}
                                                     </textarea>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-2">
                    <div class="form-group">
                        ...
                        <textarea data-validation="" rows="6" class="form-control "
                                  ...
                                  id="summernote1{{$language->title}}"
                                  placeholder="النص عن خدماتنا ">
                                                         {{$row2->getTranslation('qutstanding_customer_service', $language->title)}}
                                                     </textarea>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-2">
                    <div class="form-group">
                        ...
                        <textarea data-validation="" rows="6" class="form-control "
                                  ...
                                  id="summernote1{{$language->title}}"
                                  placeholder="النص عن خدماتنا ">
                                                         {{$row2->getTranslation('salary_definition_from_the_employer_or_bank_statement', $language->title)}}
                                                     </textarea>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-2">
                    <div class="form-group">
                        ...
                        <textarea data-validation="" rows="6" class="form-control "
                                  ...
                                  id="summernote1{{$language->title}}"
                                  placeholder="النص عن خدماتنا ">
                                                         {{$row2->getTranslation('original_visa', $language->title)}}
                                                     </textarea>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-2">
                    <div class="form-group">
                        ...
                        <textarea data-validation="" rows="6" class="form-control "
                                  ...
                                  id="summernote1{{$language->title}}"
                                  placeholder="النص عن خدماتنا ">
                                                         {{$row2->getTranslation('signing_recruitment_contract', $language->title)}}
                                                     </textarea>
                    </div>
                </div>
            @endforeach
