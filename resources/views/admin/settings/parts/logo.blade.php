        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-md-10">
                <input type="file"
                       ...
                       class="form-control dropify" id="header_logo" name="header_logo"
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-md-10">
                <input type="file"
                       ...
                       class="form-control dropify" id="footer_logo" name="footer_logo"
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-md-10">
                <input type="file" data-default-file="{{get_file($settings->tap_logo)}}"
                       class="form-control dropify" id="tap_logo" name="tap_logo"
                       placeholder="اللوجو (الاضافى)">

            </div>
        </div>

        <div class="form-group row mb-4">
            <label for="header_logo" class="col-md-2 col-form-label"> صورة من نحن
               </label>
            <div class="col-md-10">
                <input type="file" data-default-file="{{get_file($settings->about_us_image)}}"
                       class="form-control dropify" id="tap_logo" name="about_us_image"
                       placeholder=" صورة من نحن">
