                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-2">
                    <div class="form-group">
                        <label
                            ...
                            السادسة </label>
                        <textarea data-validation="" rows="6" class="form-control "
                                  name="recruitment_step6_desc[]"
                                  id="summernote1{{$language->title}}"
                                  placeholder="الخطوة الخامسة    ">
                                                         {{$settings->getTranslation('recruitment_step6_desc', $language->title)}}
                                                     </textarea>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-2">
                    <div class="form-group">
                        <label
                            ...
                            السابعة </label>
                        <textarea data-validation="" rows="6" class="form-control "
                                  name="recruitment_step7_desc[]"
                                  id="summernote1{{$language->title}}"
                                  placeholder="الخطوة الخامسة    ">
                                                         {{$settings->getTranslation('recruitment_step7_desc', $language->title)}}
                                                     </textarea>
                    </div>
                </div>
            @endforeach
