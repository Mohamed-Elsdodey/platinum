...
class AdminSettingController extends Controller
{
    ...
    {
        $title = $footer_desc = $address1=$about_us=$service_providers_title=$service_providers_desc=$integrated_digital_services_title=$integrated_digital_services_desc
            =$outstanding_customer_service_title=$outstanding_customer_service_desc
            = [];
    ...
    private function updateLogo($setting, $request)
    {
        ...
        if ($request->about_us_image){
            $data['about_us_image']=$request->hasFile('about_us_image') ? $this->uploadFiles('settings',$request->about_us_image,$request->about_us_image):$setting->about_us_image;
    ...
    private function updateStep($request)
    {
        ...
        $recruitment_step3_desc = $recruitment_step4_desc = $recruitment_step5_desc=$recruitment_step6_desc=$recruitment_step7_desc= [];
        foreach (Language::where('is_active', 'active')->get() as $index => $language) {
            ...
            $recruitment_step6_desc[$language->title] = $request->recruitment_step6_desc[$index];
            $recruitment_step7_desc[$language->title] = $request->recruitment_step7_desc[$index];
        ...
        return [
            ...
            "recruitment_step6_desc" => $recruitment_step6_desc,
            "recruitment_step7_desc" => $recruitment_step7_desc,
